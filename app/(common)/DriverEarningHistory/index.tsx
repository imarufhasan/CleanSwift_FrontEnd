    ...
    <SafeAreaView className="flex-1 bg-white px-5">
      ...
      <View className="mt-6">
        <View className="flex-row gap-4">
          ...
          <View className="flex-1 bg-white border border-gray-200 rounded-xl p-4">
            ...
            <Text className="text-green-500 font-bold text-2xl mt-2">$200</Text>
          </View>

          {/* Card 2 */}
          <View className="flex-1 bg-white border border-gray-200 rounded-xl p-4">
            <Text className="text-gray-500 text-sm">Weekly Earning</Text>
            <Text className="text-black font-bold text-2xl mt-2">$950</Text>
          </View>
        </View>
      </View>
      ...
      <View className="mt-6">
        <View className="flex-row gap-4 mb-4">
          ...
          <Text style={{color: Colors.primary}} className=" text-lg">Earning Details</Text>
        </View>
