          ...
          >
            <View className="flex-1 justify-center py-8">
              ...
              <View className="flex-row items-center my-10">
                ...
                <Text className="mx-4 text-[#7d848d] text-sm">
                  or continue with
                </Text>
                <View className="flex-1 h-[1px] bg-[#e5e7eb]" />
              </View>
              ...
              <View className="mt-8 pb-10 flex-row justify-center">
                <Text className="text-[#7d848d] text-sm">
                  Don't have an account?{" "}
                </Text>
                <TouchableOpacity onPress={() => router.push("/register")}>
                  <Text className="text-[#1a1c1e] text-sm font-bold">
                    Register
                  </Text>
                </TouchableOpacity>
              </View>
